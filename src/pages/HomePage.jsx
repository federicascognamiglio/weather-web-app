            ...
            {currWeather && Object.keys(currWeather).length > 0 &&
                <div className="container-sm">
                    ...
                    <section className='my-5'>
                        ...
                        <div className="row gx-2 gy-4 align-items-end text-center text-md-start">

                            {/* Column 1: Basic Info */}
                            <div className="col-12 col-md-4 d-flex align-items-center text-center text-md-start">
